...
- [Commands](/docs/cli/commands) - every command, flag by flag.
- [Output](/docs/cli/output) - the JSON-by-default output contract and `--pretty`.
- [Streaming](/docs/cli/streaming) - piping bodies through stdin and stdout.
- [Agents](/docs/cli/agents) - using the CLI from coding agents, plus the built-in MCP server.
