...
- **Conditional calls** keep the ordinary method `type` and add `condition` (`"create"`, `"replace"`, `"exact-read"`, `"match-delete"`, or `"conditional-copy"`). The ETag itself is not included.
