...
Returns the same [`StoredFile`](/docs/api/stored-file) shape as [`download`](/docs/api/download), without materializing the body. Calling a body accessor on the result lazy-fetches.
