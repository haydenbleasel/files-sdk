...
const loadRegistry = async (): Promise<RegistryIndex> => {
  ...
  // SAFETY: `registry.json` is generated by this app's own
  // `scripts/build-registry.ts` to the shadcn `registry.json` schema that
  // `RegistryIndex` mirrors; it is never user-supplied input.
